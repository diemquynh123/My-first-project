...
if (isset($_POST["submit"])) {
   ...
   $sql="select * from qlthanhvien where email='$email'and mat_khau='$pass'and quyen_truy_cap='2' ";
   ...
   if($row>=1){
    ...
    echo "<center class='alert alert-danger'>tài khoản không hợp lệ</center>";
   }
}
}
?>
                    ...
                    <div class="panel-body">
                        ...
                        <form method="post" role="form">
                            <fieldset>
                                ...
                                <br/>
                                <input type="submit" style="background: #13a6ef;" name="submit" value="Đăng nhập" class="btn btn-primary">
                                <input type="reset" style="background: #13a6ef;" name="resset" value="Làm mới" class="btn btn-primary" />							
                            </fieldset>
                        </form><?php } else {
     header("location:quantri.php");
                }
